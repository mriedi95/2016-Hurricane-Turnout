...
#CHANGE UNKNOWN FROM BEING LABELED "9" TO "8"
fl_voter$v21 <- as.character(fl_voter$v21)
fl_voter$v21[fl_voter$v21 == "9"] <- "8"
voted_subset$v21 <- as.character(voted_subset$v21)
voted_subset$v21[voted_subset$v21 == "9"] <- "8"
reg_subset$v21 <- as.character(reg_subset$v21)
reg_subset$v21[reg_subset$v21 == "9"] <- "8"
